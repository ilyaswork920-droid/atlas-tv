...
const cards = [
  {
    icon: MessageCircle,
    title: "WhatsApp",
    description: "The fastest way to reach us — usually a reply within minutes.",
  ...
  },
  {
    icon: Mail,
    title: "Email",
    description: "For anything that isn't urgent, drop us a line.",
  ...
  },
  {
    icon: Clock,
    title: "Response Time",
    description: "Our team typically responds within 15–30 minutes, 24/7.",
    action: null,
    href: null,
    external: false,
  },
